...
export function readRpc<T>(accessToken:string,functionName:string,body:Record<string,unknown>){return request<T>(accessToken,`rpc/${functionName}`,{method:"POST",body:JSON.stringify(body)});}
